...
def interpolator_scan(dirname):
    ...
    We vary both the functional form (piecewise-linear, cubic, Fourier modes, etc) and the dimension.
    """
    ...
    base_params = {"alpha": 1, "mu_scale": .01, "order":3 , "max_t": 60, "dt": 1e-3, "modes": 21,
        "timestepper":"rk4", "initial_guess": {"lambda2": 2}}
